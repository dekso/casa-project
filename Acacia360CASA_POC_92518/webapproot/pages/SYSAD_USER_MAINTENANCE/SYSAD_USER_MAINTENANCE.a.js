...
fNewRole: ["wm.SelectMenu", {"_classes":{"domNode":["selectMenu"]},"border":"0","caption":"Role:","captionSize":"150px","dataType":"com.casa.util.forms.DescIdForm","dataValue":undefined,"displayField":"description","displayValue":"","height":"25px","required":true}, {"onchange":"svGetGroupListEDIT"}, {
binding: ["wm.Binding", {}, {}, {
wire: ["wm.Wire", {"expression":undefined,"source":"svRole","targetProperty":"dataSet"}, {}]
}]
}],
fNewTellerslimit: ["wm.Number", {"_classes":{"domNode":["sText"]},"applyPlacesWhileTyping":true,"border":"0","caption":"Tellers Limit:","captionSize":"150px","dataValue":0,"displayValue":"0.00","emptyValue":"zero","formatter":undefined,"height":"25px","invalidMessage":"Not a valid email address","places":2,"width":"400px"}, {}, {
binding: ["wm.Binding", {}, {}, {
...
fNewPassExpDate: ["wm.Date", {"border":"0","caption":"Password Expiry Date:","captionSize":"150px","datePattern":"M/d/yyyy","displayValue":"9/12/2018","emptyValue":"null","formatter":undefined,"height":"25px","required":true}, {}, {
binding: ["wm.Binding", {}, {}, {
...
fNewValidDateFrom: ["wm.Date", {"border":"0","caption":"Account Validity From:","captionSize":"150px","datePattern":"M/d/yyyy","displayValue":"9/12/2018","emptyValue":"null","formatter":undefined,"height":"25px","required":true}, {}, {
binding: ["wm.Binding", {}, {}, {
...
fNewValidDateTo: ["wm.Date", {"border":"0","caption":"Account Validity To:","captionSize":"150px","datePattern":"M/d/yyyy","displayValue":"9/12/2018","emptyValue":"null","formatter":"Date","height":"25px","minimum":null,"required":true,"styles":{}}, {"onchange":"fNewValidDateToChange"}, {
binding: ["wm.Binding", {}, {}, {
...
fEditTellerslimit: ["wm.Number", {"_classes":{"domNode":["sText"]},"applyPlacesWhileTyping":true,"border":"0","caption":"Tellers Limit:","captionSize":"150px","displayValue":"","emptyValue":"zero","height":"25px","places":2,"styles":{}}, {}, {
binding: ["wm.Binding", {}, {}, {
wire: ["wm.Wire", {"expression":"${fEditRole.dataValue}==\"teller\"","targetProperty":"showing"}, {}],
wire1: ["wm.Wire", {"expression":undefined,"source":"svUserDetail.limitamount","targetProperty":"dataValue"}, {}]
}]
}],
...
{"show":false,"field":"unitbalance","title":"Unitbalance","width":"100%","align":"left","formatFunc":"","mobileColumn":false},
...
SYSAD_USER_MAINTENANCE.prototype._cssText = '';
SYSAD_USER_MAINTENANCE.prototype._htmlText = '';