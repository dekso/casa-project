dojo.declare("RPT_ALLREJECTEDTRANS", wm.Page, {
start: function() {
...
RPT_ALLREJECTEDTRANS.widgets = {
svAllRejectedTrans: ["wm.ServiceVariable", {"inFlightBehavior":"executeLast","operation":"AllRejectedTrans","service":"Report"}, {}, {
...
label1: ["wm.Label", {"caption":"All Rejected Transaction","height":"28px","padding":"4","styles":{"color":"#ffffff","fontWeight":"bold","fontSize":"18px","backgroundColor":"#315476"},"width":"100%"}, {}],
...
button1: ["wm.Button", {"border":"1","caption":"Generate","desktopHeight":"25px","height":"25px","width":"80px"}, {"onclick":"svAllRejectedTrans"}]
}]
}],
...
binding: ["wm.Binding", {}, {}, {
wire: ["wm.Wire", {"expression":"${svAllRejectedTrans.dataValue}","targetProperty":"source"}, {}]
}]
}]
}]
}]
...
RPT_ALLREJECTEDTRANS.prototype._cssText = '';
RPT_ALLREJECTEDTRANS.prototype._htmlText = '';