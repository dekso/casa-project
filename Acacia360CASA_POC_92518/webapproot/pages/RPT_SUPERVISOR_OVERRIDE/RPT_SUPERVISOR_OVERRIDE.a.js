dojo.declare("RPT_SUPERVISOR_OVERRIDE", wm.Page, {
start: function() {
//this.svTellersTotal.update();
},
"preferredDevice": "desktop",
_end: 0
});

RPT_SUPERVISOR_OVERRIDE.widgets = {
svSupervisorOverride: ["wm.ServiceVariable", {"inFlightBehavior":"executeLast","operation":"SupOverridetx","service":"Report"}, {}, {
input: ["wm.ServiceInput", {"type":"SupOverridetxInputs"}, {}, {
binding: ["wm.Binding", {}, {}, {
...
label1: ["wm.Label", {"caption":"Supervisor Override","height":"28px","padding":"4","styles":{"color":"#ffffff","fontWeight":"bold","fontSize":"18px","backgroundColor":"#315476"},"width":"100%"}, {}],
...
button1: ["wm.Button", {"border":"1","caption":"Generate","desktopHeight":"25px","height":"25px","width":"80px"}, {"onclick":"svSupervisorOverride"}]
}]
}],
...
binding: ["wm.Binding", {}, {}, {
wire: ["wm.Wire", {"expression":"${svSupervisorOverride.dataValue}","targetProperty":"source"}, {}]
}]
}]
}]
}]
...
RPT_SUPERVISOR_OVERRIDE.prototype._cssText = '';
RPT_SUPERVISOR_OVERRIDE.prototype._htmlText = '';