dojo.declare("CSR_PLACE_GARNISH", wm.Page, {
start: function() {
...
app.alert("Place Garnish Amount Successful!");
...
CSR_PLACE_GARNISH.prototype._cssText = '';
CSR_PLACE_GARNISH.prototype._htmlText = '';