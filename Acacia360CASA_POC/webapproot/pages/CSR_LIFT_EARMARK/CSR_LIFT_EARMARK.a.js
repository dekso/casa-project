dojo.declare("CSR_LIFT_EARMARK", wm.Page, {
start: function() {
...
app.confirm("Proceed to lift earmark amount?", false,
...
app.alert("Lift Hold Earmark Amount Successful!");
this.dlgAcctDet.hide();
...
wire1: ["wm.Wire", {"expression":"3","targetProperty":"type"}, {}]
}]
}]
}],
...
wire3: ["wm.Wire", {"expression":"3","targetProperty":"type"}, {}]
}]
}]
}],
...
dlgAcctDet: ["wm.DesignableDialog", {"border":"1","buttonBarId":"","containerWidgetId":"containerWidget","desktopHeight":"210px","height":"210px","title":"Account Details"}, {}, {
containerWidget: ["wm.Container", {"_classes":{"domNode":["wmdialogcontainer","MainContent"]},"autoScroll":true,"height":"100%","horizontalAlign":"left","padding":"5","verticalAlign":"top","width":"100%"}, {}, {
pnlAcctDet: ["wm.Panel", {"height":"131px","horizontalAlign":"left","layoutKind":"left-to-right","verticalAlign":"top","width":"100%"}, {}, {
...
flExpirydt: ["wm.Date", {"_classes":{"domNode":["DateN"]},"border":"0","caption":"Expiry Date:","displayValue":"","height":"25px","readonly":true,"showing":false}, {}, {
binding: ["wm.Binding", {}, {}, {
...
flLiftReason: ["wm.SelectMenu", {"_classes":{"domNode":["selectMenu"]},"border":"0","caption":"Lift Reason","captionSize":"110px","dataField":"id","dataType":"com.casa.util.forms.DescIdForm","dataValue":undefined,"displayField":"description","displayValue":"","height":"25px","required":true,"width":"300px"}, {}, {
binding: ["wm.Binding", {}, {}, {
...
btnLift: ["wm.Button", {"border":"1","caption":"Lift Earmark Amount","desktopHeight":"28px","height":"28px","styles":{},"width":"141px"}, {"onclick":"btnLiftClick"}, {
binding: ["wm.Binding", {}, {}, {
...
label2: ["wm.Label", {"caption":"Lift Earmark Amount","height":"31px","padding":"4","styles":{"fontSize":"14px","fontWeight":"bolder","color":"#535050"},"width":"306px"}, {}]
}],
...
CSR_LIFT_EARMARK.prototype._cssText = '';
CSR_LIFT_EARMARK.prototype._htmlText = '';