dojo.declare("RPT_TELLERS_TOTAL", wm.Page, {
start: function() {
...
RPT_TELLERS_TOTAL.widgets = {
svTellersTotal: ["wm.ServiceVariable", {"inFlightBehavior":"executeLast","operation":"TellersTotal","service":"Report"}, {}, {
...
label1: ["wm.Label", {"caption":"Teller's Total","height":"28px","padding":"4","styles":{"color":"#ffffff","fontWeight":"bold","fontSize":"18px","backgroundColor":"#315476"},"width":"100%"}, {}],
...
button1: ["wm.Button", {"border":"1","caption":"Generate","desktopHeight":"25px","height":"25px","width":"80px"}, {"onclick":"svTellersTotal"}]
}]
}],
...
binding: ["wm.Binding", {}, {}, {
wire: ["wm.Wire", {"expression":"${svTellersTotal.dataValue}","targetProperty":"source"}, {}]
}]
}]
}]
}]
...
RPT_TELLERS_TOTAL.prototype._cssText = '';
RPT_TELLERS_TOTAL.prototype._htmlText = '';